...
$salonDetails = $salon_db->getSalonDetails($salonid);

include_once "header.php";
?>

<title>Salons | Profile</title>
</head>
<body id="homePage">
...
<div class="container-fluid">
    <div class="text-center text-primary page-header">
        <h1><?php echo $salonname ?>'s Profile!</h1>
    </div>
    <div class="row">
     <table class="col-sm-4 col-sm-offset-4"  style="font-family: 'Andale Mono'">
            <tbody>
                <tr>
                    <td>Address:</td>
                    <td><?php echo $salonDetails['streetaddress'] . ', <br> ' . $salonDetails['city'] . ', <br> ' . $salonDetails['province'] . ', ' . $salonDetails['postalcode']?></td>
                </tr>
                <tr>
                    <td>Phone:</td>
                    <td><?php echo $salonDetails['phone'] ?></td>
                </tr>
                <tr>
                    <td>Email:</td>
                    <td><?php echo $salonDetails['email'] ?></td>
                </tr>
            </tbody>
        </table>
        </div>
