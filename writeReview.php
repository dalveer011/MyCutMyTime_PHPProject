...
$user = new User();
$customerId = $user->getCustomeridByemail($userEmail);

$salon_db = new Salons_db();
$salons = $salon_db->getAllSalonsWhereCustomerHasAppointments($customerId);
...
<head>
    ...
    <link rel="stylesheet" href="bootstrap-star-rating-master/css/themes/krajee-fa/theme.css" media="all" type="text/css"/>
    <link rel="stylesheet" href="bootstrap-star-rating-master/css/themes/krajee-svg/theme.css" media="all" type="text/css"/>
    <link rel="stylesheet" href="bootstrap-star-rating-master/css/themes/krajee-uni/theme.css" media="all" type="text/css"/>
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <form method="post" action="addReview.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" id="titleInput" placeholder="Enter a title for review" required>
                </div>
                <div class="form-group">
                    <label for="selectSalon">Select Salon</label>
                    <select class="form-control" id="selectSalon" name="salonName">
                        <?php foreach ($salons as $salon) :?>
                        <option value="<?php echo $salon['name'] ?>"><?php echo $salon['name'] ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>

                <div class="form-group">
                    <label for="titleRating">Rating</label>
                    <input type="text" class="rating rating-loading form-control" value="1" data-size="lg" id="titleRating" name="rating" required>
                </div>

                <div class="form-group">
                    <label for="reviewDescription">Write a Review</label>
                    <textarea class="form-control" id="reviewDescription" rows="3" name="reviewDescription" required></textarea>
                </div>
