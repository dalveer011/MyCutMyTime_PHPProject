...
<div class="container-fluid">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-2">
                ...
                <form method="post" action="addAService.php" name="addSalonForm" onsubmit="return(validateServices())">
                    <div class="form-group">
                        <label>Service Description</label>
                        <input type="text" class="form-control" name="serviceDescription" id="description" placeholder="Enter Service Description" required value="">
                        <small id="descErr" class="form-text text-muted">Chop chop enter your service.</small><br>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Price</label>
                        <input type="text" class="form-control" id="price" aria-describedby="emailHelp" placeholder="Enter price" name="price" required value="">
                        <small id="priceErr" class="form-text text-muted">Be sure to be competitve</small><br>
                        </div>
                    <input type="hidden" name="salonid" value= "<?php echo $salonid ?>">
